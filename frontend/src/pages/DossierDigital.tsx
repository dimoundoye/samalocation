...
import { Shield, FileText, Upload, CheckCircle2, AlertCircle, Building2, Briefcase, Wallet, Users, ArrowRight, Loader2 } from "lucide-react";
...
import { getMyDossier, saveDossier, TenantDossier } from "@/api/dossier";
import { baseClient } from "@/api/baseClient";
import SEO from "@/components/SEO";

const DossierDigital = () => {
    ...
    const calculateCompletion = () => {
        ...
        if (dossier.occupants_count) score += 5; // Bonus for precision
    ...
    return (
        <div className="min-h-screen bg-background">
            <SEO title="Mon Dossier Digital | SamaLocation" description="Gérez votre dossier locatif digital et postulez en un clic." />
            <Navbar />
            ...
            <main className="container mx-auto px-6 pt-32 pb-20">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
                        <div>
                            <h1 className="text-4xl font-bold tracking-tight mb-2">Mon Dossier Digital</h1>
