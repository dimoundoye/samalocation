...
import { Eye, FileText, Download, ShieldCheck, Crown, Lock } from "lucide-react";
                                ...
                                <div className="w-full h-full flex flex-col">
                                    <div className="p-4 bg-white border-b flex items-center justify-between">
                                        ...
                                        <Button size="sm" variant="ghost" className="gap-2" asChild>
                                            <a href={`${window.location.origin}/contrat_standard.pdf?v=20240427`} download>
                                                <Download className="h-4 w-4" /> Télécharger
                                            </a>
                                        </Button>
                                    </div>
                                    <iframe
                                        src={`${window.location.origin}/contrat_standard.pdf?v=20240427#toolbar=0`}
                                ...
                                <div className="w-full h-full flex flex-col">
                                    <div className="p-4 bg-slate-900 text-white border-b border-slate-800 flex items-center justify-between">
                                        ...
                                        <Button size="sm" variant="secondary" className="gap-2 bg-white text-slate-900 hover:bg-slate-100" asChild>
                                            <a href={`${window.location.origin}/contrat_premium.pdf?v=20240427`} download>
                                                <Download className="h-4 w-4" /> Télécharger
                                            </a>
                                        </Button>
                                    </div>
                                    <iframe
                                        src={`${window.location.origin}/contrat_premium.pdf?v=20240427#toolbar=0`}
                                        className="w-full flex-1 border-none"
